...
- A scene may contain AT MOST ONE axes element, and every plot/point/mathline in the scene shares it. To show two different graphs, either draw both plots on the same axes or split them into two segments — NEVER add a second axes element.
