...
The service accepts only the eight allowlisted derivative templates and validated numeric parameters. It never accepts Python source, filesystem paths, or shell arguments. The web app keeps a deterministic SVG fallback when this optional worker is unavailable.
